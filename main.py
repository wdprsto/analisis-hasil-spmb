...
with cold11:
    ...
    st.dataframe(df_eda[df_eda['hasil.akhir_x']=='Lulus']['nama.pendidikan'].value_counts().reset_index().rename(columns={"index":"jenjang_pendidikan", "nama.pendidikan":"jumlah_lulus"}).set_index("jenjang_pendidikan"))
